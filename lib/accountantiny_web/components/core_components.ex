defmodule AccountantinyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AccountantinyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AccountantinyWeb.Gettext, "errors", msg, opts)
    end
  end
